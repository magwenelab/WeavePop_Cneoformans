...
do
   parallel -j ${snakemake_threads[0]} "seqkit faidx genomes-annotations/{}/predicted_proteins.fa $protein | seqkit replace -p '($)' -r ' sample={}'"  :::: ${snakemake_input[1]} > proteins/$protein.fa
