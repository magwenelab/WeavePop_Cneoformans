...
output_file <- paste("notebooks/logs/ploidy_depth_whole_genome", params$sample_id, ".txt")
sink(output_file)
...
```{r}
write_tsv(components, paste0("../results/tables/components_", params$sample_id, ".tsv"))
```
