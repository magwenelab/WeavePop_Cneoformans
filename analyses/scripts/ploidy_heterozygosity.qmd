...
sample_id = "ERS1142758"
dataset = "Ashton"
params <- list(dataset = dataset, sample_id = sample_id)
```
```{r, output=FALSE}
library(tidyverse)
library(vcfR)
...
chromosomes_path <- paste("../Crypto_", params$dataset, "/config/chromosomes.csv", sep = "")
raw_vcf_path <- paste("../Crypto_", params$dataset, 
                      "/results_clean/01.Samples/snippy/", 
                      params$sample_id, "/snps.raw.vcf", sep = "")
```
...
chrom_names <- read_csv(chromosomes_path)
