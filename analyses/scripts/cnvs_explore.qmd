...
- [Prepare dataset](#prepare-dataset)
    ...
    - [Get the chromosome median depth](#get-the-chromosome-median-depth)
    - [Get metrics of duplications from called CNVs](#get-metrics-of-duplications-from-called-cnvs)
- [Explore repeats](#explore-repeats)
- [Explore called duplications](#explore-called-duplications)
    - [Filter out duplication of Chr2](#filter-out-duplication-of-chr2)
    - [Provisional filtration of chr01 VNI duplication](#provisional-filtration-of-chr01-vni-duplication)
- [Join all data and metadata](#join-all-data-and-metadata)
- [Get metrics per chromosome](#get-metrics-per-chromosome)
