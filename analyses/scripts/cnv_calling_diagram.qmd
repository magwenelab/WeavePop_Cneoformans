...
```{r}
windows_path <- 
    "../Crypto_Ashton/results/04.Intermediate_files/01.Samples/depth_quality/ERS542302/depth_by_windows.tsv"
cnv_path <- 
    "../Crypto_Ashton/results/01.Samples/cnv/ERS542302/cnv_calls.tsv"
repeats_path <- "../Crypto_Ashton/results/03.References/VNI/VNI_repeats.bed"
```
...
```{r}
windows_path <- 
    "../Crypto_Ashton/results/04.Intermediate_files/01.Samples/depth_quality/ERS542554/depth_by_windows.tsv"
cnv_path <- 
    "../Crypto_Ashton/results/01.Samples/cnv/ERS542554/cnv_calls.tsv"
repeats_path <- "../Crypto_Ashton/results/03.References/VNI/VNI_repeats.bed"
```
