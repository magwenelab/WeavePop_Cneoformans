...
```
### Dataset, country, source

#### Fully duplicated chromsomes
...
### Country, source, tiplabels, hilight and cladelab
...
#| fig-width: 6.5
#| fig-align: center
m3 <- gheatmap(m1, dup_chroms, width=.25, colnames = TRUE,
...
#| fig-width: 6.5
#| fig-align: center
m3 <- gheatmap(m1, dup_coverage, width=.25, colnames = TRUE,
                colnames_position = "top",
                colnames_angle = 45,
                colnames_offset_y = 0.5,
                font.size = 1.5, offset=2.8) +
...
#| fig-width: 6.5
#| fig-align: center
m3 <- gheatmap(m1, dup_category_size, width=.25, colnames = TRUE,
                colnames_position = "top",
                colnames_angle = 45,
                colnames_offset_y = 0.5,
                font.size = 1.5, offset=2.8) +
...
```
```{r, message=FALSE, warning=FALSE}
ggsave(tree_merged_duplications_small1, m3, height = 4.5, width = 6.5, units = "in", dpi = 900)
```
#### Size category of duplications
```{r, message=FALSE, warning=FALSE}
#| fig-height: 5
...
#| fig-width: 6.5
#| fig-align: center
m3 <- gheatmap(m, dup_category_aneuploidy, width=0.2, colnames = TRUE,
                colnames_position = "top",
                colnames_angle = 90,
                colnames_offset_y = 1,
                font.size = 1.5, 
