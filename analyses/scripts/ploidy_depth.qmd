...
path <- paste("../Crypto_", params$dataset,
    "/results_clean/04.Intermediate_files/01.Samples/depth_quality/",
    params$sample_id,
    "/depth_by_windows.tsv",
     sep = "")
depth_by_windows_path <- paste("../../Crypto_", 
    params$dataset, 
    "/results_clean/01.Samples/plots/",
    params$sample_id,
    "/depth_by_windows.png",
    sep = "")

chrom_names_path <- paste("../Crypto_",
                          params$dataset,
                          "/config/chromosomes.csv", sep ="")

log_wg_path <- paste("notebooks/scripts/ploidy_depth/logs/whole_genome_", params$sample_id, ".txt")
log_chrom_path <- paste("notebooks/scripts/ploidy_depth/logs/chromosomes_", params$sample_id, ".txt")

components_path <- paste0("results/tables/components_", params$sample_id, ".tsv")
```
