...
```{r}
lineage_colors <- brewer.pal(8, "Dark2")[c(1, 2, 3, 4,5)]
...
missing_tips <- setdiff(tips, metadata$strain)
missing_tips
```
...
```{r, echo=FALSE, eval=FALSE}
ggsave("../tree_duplications/results/figures/tree_ashton.png", p1, height = 10, width = 10, units = "in", dpi = 600)
```
