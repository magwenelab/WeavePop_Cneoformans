...
```{r}
ggplot(dup_calls, aes(x = repeat_fraction, y = smooth_depth)) +
...
```{r}
ggplot(dup_calls, aes(x = region_size, y = smooth_depth)) +
        geom_point(aes(color = lineage)) +
        facet_wrap(~chromosome, ncol = 2)+
...
```{r}
ggplot(dup_calls, aes(x = start, y = smooth_depth)) +
        geom_point(aes(color = lineage)) +
...
```
```{r}
ggplot(dup_calls_filtered, aes(x = repeat_fraction, y = smooth_depth)) +
        geom_point(aes(color = lineage)) +
        facet_wrap(~chromosome, ncol = 2)+
        theme_minimal() +
        theme(legend.position = "bottom")+
...
```{r}
ggplot(dup_calls_filtered, aes(x = region_size, y = smooth_depth)) +
        geom_point(aes(color = lineage)) +
        facet_wrap(~chromosome, ncol = 2)+
        scale_x_continuous(labels = scales::comma) +
        theme_minimal() +
...
```{r}
ggplot(dup_calls_filtered, aes(x = start, y = smooth_depth)) +
        geom_point(aes(color = lineage)) +
