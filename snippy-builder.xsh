...
THREADS = 12
#Inputs
SAMPREFTABLE = "sample_reference.csv"
...
# Get table with samplename, fq.gz filenames and reference filename

df = pd.read_csv(SAMPREFTABLE)
...
#     fasterq-dump @(srapath) -O @(fastqdir) -p0