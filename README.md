...
A table with genes of interest to add to the plots was created with: Centromere delimiting-gene IDs from Janbon 2014. MAT loci protein_coding_gene IDs (everything between SXI1 and STE12) of the VNI genome. rRNA genes from the VNI annotation with the tags level1 ncRNA and level2 rRNA.  
  * `config/loci.csv`

The RepBase database of consensus repetitive sequences was downloaded with the following steps:  
```
